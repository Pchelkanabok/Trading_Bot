...
def first_data(work_time_, work_time_sko_):
    ...
    def quantity():
        ...
        work_list_1.clear()
        try:
            work_list_1.append(qp_provider.GetFuturesHoldings()['data'][1]['seccode'])
            work_list_1.append(qp_provider.GetFuturesHoldings()['data'][1]['totalnet'])
        except IndexError:
        ...
        work_list_2.clear()
        try:
            work_list_2.append(qp_provider.GetFuturesHoldings()['data'][2]['seccode'])
            work_list_2.append(qp_provider.GetFuturesHoldings()['data'][2]['totalnet'])
        except IndexError:
    ...
    def test(work_time_, work_time_sko_):
        ...
        pref_quantity, ob_quantity, deal_quantity, deal_now_spread = 0, 0, 0, 0
        ...
        for x_x in range(work_time_sko_ + 80):
        ...
        while xx <= work_time_ or shares_pref != 0 or shares_ob != 0:
            ...
            if shares_pref == 0 and shares_ob == 0:
                ...
                if sr_spread > sr_spread_240 * (1 + deviation_240) and spread_now > sr_spread_240:
                    ...
                    balance_old = balance
                    deal_now_spread = spread_now  # запоминаем спред покупки, выстраиваем стоп-лоссы и тейк-профиты от него
                ...
                if (sr_spread <= sr_spread_240 * (1 + deviation_240 * 0.1)) and shares_pref == 1 and shares_ob == -1 and deal_now_spread > spread_now:
                ...
                elif (sr_spread >= sr_spread_240 * (1 - deviation_240 * 0.1)) and shares_ob == 1 and shares_pref == -1 and deal_now_spread < spread_now:
                ...
                elif (sr_spread > deal_spread * (1 + deviation_240 * 2.5)) and shares_pref == 1 and shares_ob == -1:
                ...
                elif (deal_spread * (1 - deviation_240 * 2.5) > sr_spread) and shares_ob == 1 and shares_pref == -1:
